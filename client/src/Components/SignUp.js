      ...
      return(
        <div> 
          <form method='POST' onSubmit={this._addData} className="SignUpBox">
            ...
            <input type='text'  name="password" maxLength='20' placeholder="password"   onChange={(e) => this.SignUp(e)}/><br></br>
            ...
            <input type='radio' name="gender"   value="남"     onChange={(e) => this.SignUp(e)}/><br></br>
            <input type='radio' name="gender"   value="여"     onChange={(e) => this.SignUp(e)}/><br></br>
